...
A nest of meenlocks lives in the mine outside the village. Though most of the creatures returned to the Feywild once the village was empty, six [**meenlocks**](statblocks/VGM/Meenlock.md) (see the end of the adventure for their stat block) remained to prey on lost travelers. When the characters arrive in the village, these meenlocks become aware of their presence and stalk them from a distance, staying hidden in the shadows.
...
>
>The [**meenlocks**](statblocks/VGM/Meenlock.md) haunting Vermeillon avoid bright light. They prefer to stay in their nest until nightfall, though they sometimes hunt on overcast days.
>
...
>
>Mayor Lei Duvezin was taken in the night and transformed into a meenlock. The [**meenlock**](statblocks/VGM/Meenlock.md) that was once Mayor Duvezin now lurks around the mayor's mansion, drawn there by lingering memories, and it takes any opportunity to attack characters in the house.
>
...
***Development.*** A character who wanders into this cave alone and is grappled by the mossy tentacles might have to deal with one or more [**meenlocks**](statblocks/VGM/Meenlock.md) that creep into the room, hoping to take advantage of the character's unfortunate predicament.
...
This is another ideal ambush location for the meenlocks or, if you want to shake things up a bit, for a [**black pudding**](statblocks/MM/Black Pudding.md) or other ooze to lurk on the surface of one of the pools like an oil slick.
...
![Meenlock](img/adventure/CM/040-636463380268253619.webp)
