...
- Lord Viallis's closest business associate was an elf named [**Faerl**](statblocks/CM/Faerl.md), who visited Lord Viallis twice a tenday.
...
Once she appears for the first time, Sarah (a [**ghost**](statblocks/MM/Ghost.md)) reappears whenever the characters speak her name in the presence of the book. The anguished state of the young woman's spirit is clear to anyone who sees her.
...
The manor is on Delzorin Street in the North Ward, and it is now home to the Falgarst family. Characters who present themselves at the estate are met by a well-dressed butler at the front door. Arnulf (a lawful neutral human [**commoner**](statblocks/MM/Commoner.md)) is a short, balding man with a warm smile and a fine mustache, who gives off a faint scent of wine. He is amicable and conversational, especially if he has already undertaken his daily "inspection" of the Falgarst family's wine cellar.
...
The characters can get on the good side of one of the cobblers or tannery managers working for Viallis with a successful DC 15 Charisma (Persuasion) check or 10 gp in bribes. Doing so earns them the knowledge that Lord Viallis has an overseer who comes once every second tenday to check the books of each enterprise, pay wages, and collect profits. The overseer, an elf named [**Faerl**](statblocks/CM/Faerl.md), lives in the village of Greenfast southeast of Waterdeep, and is expected in the city in two days.

The characters are free to head for the village in search of more clues, in which you can case skip to the "Greenfast" section later in the adventure. They can also wait in Waterdeep to try to talk to [**Faerl**](statblocks/CM/Faerl.md). The overseer arrives two days later, and spends that day visiting each business in turn. Characters who stake out any of those locations can see [**Faerl**](statblocks/CM/Faerl.md) as he arrives just after noon in a private coach, which barely fits along the narrow Trades Ward streets where the Yellowcrest businesses are located. His bodyguards include two [**cult fanatics**](statblocks/MM/Cult Fanatic.md), three [**thugs**](statblocks/MM/Thug.md), and two [**veterans**](statblocks/MM/Veteran.md)—all on horseback. The driver of the coach is an unarmed [**commoner**](statblocks/MM/Commoner.md). The characters can easily perceive that this is an unusually large entourage, even for someone carrying money.

![Faerl](img/adventure/CM/069-09-003.faerl.webp)

#### Faerl

[**Faerl**](statblocks/CM/Faerl.md), a neutral evil wood elf, is proud and cruel. He believes that he must be in control at all times. He dresses in pompous finery and an oversized red hat. He speaks precisely, but in a volume so low that it forces people to pay close attention to him.

[**Faerl**](statblocks/CM/Faerl.md) uses the [**noble**](statblocks/MM/Noble.md) stat block with the following changes:
...
As long as the characters approach in a nonthreatening way, [**Faerl**](statblocks/CM/Faerl.md) is willing to talk to them, though his bodyguards stand close by. [**Faerl**](statblocks/CM/Faerl.md) pretends to take an interest in any talk of the characters looking into the Yellowcrest murders, calling the fact that no one was ever charged with the crime "a terrible injustice." If asked about Lord Viallis, [**Faerl**](statblocks/CM/Faerl.md) describes him as "broken by the tragedy." He denies that his employer could have had anything to do with those terrible events if any character suggests it.

[**Faerl**](statblocks/CM/Faerl.md)'s loyalty to the Burnt Tongue Cult and Lord Viallis is absolute, making him impervious to bribery and intimidation attempts. If magic such as a *charm person* spell is used to influence his attitude toward one or more characters, [**Faerl**](statblocks/CM/Faerl.md) refuses to mention the cult, even to characters to whom he is friendly, so as not to incriminate himself. He calls the City Watch if the party gives him trouble.

If the characters express their intention to question Lord Viallis, [**Faerl**](statblocks/CM/Faerl.md) orders his bodyguards to attack while he climbs back in the coach and tries to leave. If he gets away, he returns to Greenfast, where the characters might encounter him again.

#### Street Fight

If [**Faerl**](statblocks/CM/Faerl.md) orders his bodyguards to attack, or if any character attacks him or the bodyguards first, the bodyguards do their best to protect [**Faerl**](statblocks/CM/Faerl.md) and ensure that he escapes in the coach. They then lay into the characters without mercy. The [**cult fanatics**](statblocks/MM/Cult Fanatic.md) cast *command* or *hold person* on melee combatants, hoping that the [**veterans**](statblocks/MM/Veteran.md) and the [**thugs**](statblocks/MM/Thug.md) can dispatch them quickly. The thugs focus on the same target to make use of their Pack Tactics feature.

When more than half the bodyguards have fallen, the others surrender. All are Waterdeep mercenaries on long-term contract to guard [**Faerl**](statblocks/CM/Faerl.md) when he visits the city. They don't know Lord Viallis personally and know nothing of the cult, but they can provide the following information about [**Faerl**](statblocks/CM/Faerl.md) and Lord Viallis:

- [**Faerl**](statblocks/CM/Faerl.md) met Lord Viallis in Waterdeep years ago and became his business partner. [**Faerl**](statblocks/CM/Faerl.md) lives in the village of Greenfast southeast of Waterdeep, where Lord Viallis also lives now.
- The profits from the Yellowcrest businesses generate a tidy sum that funds Viallis's retirement.
- The bodyguards were to accompany [**Faerl**](statblocks/CM/Faerl.md) back to Greenfast that evening with the latest profits from the Yellowcrest businesses, then make their way back to Waterdeep after being paid.

***Treasure.*** If the characters overcome [**Faerl**](statblocks/CM/Faerl.md) and the bodyguards and prevent [**Faerl**](statblocks/CM/Faerl.md) from leaving, a search of the coach turns up a locked iron strongbox. [**Faerl**](statblocks/CM/Faerl.md) carries the key. As an action, a character can try to pick the lock using thieves' tools, doing so with a successful DC 15 Dexterity check, or pry the box open with a successful DC 18 Strength (Athletics) check. Inside are the profits from the establishments [**Faerl**](statblocks/CM/Faerl.md) has already visited that day—35 gp and 400 sp.

[**Faerl**](statblocks/CM/Faerl.md) carries a *potion of healing (superior)* in his belt and 20 gp in a leather pouch. He wears jewelry worth a total of 20 gp.
...
Vecken (a lawful good human [**knight**](statblocks/MM/Knight.md)) is a burly figure, heavily scarred but with a pleasant disposition. He turned to adventuring to help him move past the death of his beloved Sarah, and he becomes noticeably distraught when speaking of her.
...
The largest building in the village is the home of Mayor Kara Firenni (a neutral good human [**commoner**](statblocks/MM/Commoner.md)), who is busy working in her garden if the characters seek her out. Mayor Kara is middle-aged and wears her hair in a short ponytail. She is a good and compassionate leader, but shows clear signs of stress as the characters talk to her.
...
This tavern has a warm, homey feel, filled with locals at mealtimes and the end of the workday. Travelers stop in more rarely, and the proprietor, Old Fargo (a chaotic good human [**commoner**](statblocks/MM/Commoner.md)), is happy to serve them. Fargo is recognizable by his old flannel shirt and riding hat. The tavern has two spare rooms on the second floor that can be rented out by the day or tenday.
...
If the characters came to Greenfast without meeting [**Faerl**](statblocks/CM/Faerl.md) in Waterdeep, you can have them find the overseer at home if you see fit. Use the details in the "Yellowcrest Businesses" section and the information on [**Faerl**](statblocks/CM/Faerl.md) there to shape the conversation. If the characters threaten him or ask questions that indicate they know more about the cult than [**Faerl**](statblocks/CM/Faerl.md) likes, the overseer makes a point of opening a window "to get some air." This is a signal to the cultists at the barn (area G5) to come running.

#### G5. Barn

Two [**cult fanatics**](statblocks/MM/Cult Fanatic.md) and two [**veterans**](statblocks/MM/Veteran.md)—neutral evil humans loyal to Viallis—work here by day. They keep an eye out for trouble and keep their ears open for word of nondescript travelers passing through the area. When Viallis needs new sacrifices, the cultists snatch victims along the Trade Way at night. (If at least one day passes between the characters meeting Vecken and arriving in Greenfast, the cultists' most recent expedition ended with the capture of the vengeful warrior. See area B11.)

The cultists pay close attention to [**Faerl**](statblocks/CM/Faerl.md)'s house (area G4) and to any strangers in the village. If the characters ask them any questions about Viallis, the cultists respond by attacking. If they see the previously agreed-upon signal of a window being opened in [**Faerl**](statblocks/CM/Faerl.md)'s house, they go there immediately, ready for trouble.
...
An hour out of Greenfast stands an old stone tower, long abandoned and crumbling. When Lord Viallis came to Greenfast after murdering his family, [**Faerl**](statblocks/CM/Faerl.md) showed him the tower, thinking that Viallis might consider it a suitable site for a summer home. But Viallis, already well involved in his plans to make contact with the Great Old One called Gaernoo, saw even more potential for the site.
...
Two [**grells**](statblocks/MM/Grell.md) and four [**cultists**](statblocks/MM/Cultist.md) stand guard in this chamber. If the characters made any obvious noise as they descended the stairs (including talking), these guardians try to hide along the walls adjacent to the stairs, behind the braziers—the cultists on the ground and the grells in the air. Combat here alerts the [**cult fanatic**](statblocks/MM/Cult Fanatic.md) in area B3, who flees to area B7 to warn Lord Viallis of intruders.
...
If the characters reach this area without making any sound, they find a single [**cult fanatic**](statblocks/MM/Cult Fanatic.md) stationed at the stairs. If alerted to the characters' intrusion (such as by combat in area B1), the fanatic flees down the stairs, races along the tunnels of the lower level, up into area B8, and through the secret door into area B7 to alert Lord Viallis.
...
The trinkets are worthless, mysterious-looking objects. The books appear to be registries of purchases, as well as lists of items and people. These documents, created by [**Faerl**](statblocks/CM/Faerl.md), have nothing to do with the cult's activities but look important at a glance. Lord Viallis leaves them here to test security; if any of them go missing, Viallis knows his temple has been infiltrated by a spy or a thief. A character who spends at least 10 minutes examining the books can ascertain their lack of importance with a successful DC 15 Wisdom (Insight) check.
...
Lord Viallis Yellowcrest (a chaotic evil human [**mage**](statblocks/MM/Mage.md)) is performing a lengthy ritual that requires his undivided attention. He is surrounded by servants (see below), a bloodstained knife in his hand. The bodies of two adult humans lie dead on the altar in front of the statue, having just been sacrificed. See the "Lord Viallis" sidebar for additional guidance on how to portray this mad villain.

A [**grell**](statblocks/MM/Grell.md) and two [**cultists**](statblocks/MM/Cultist.md) stand beside Lord Viallis but break off from the ritual to repel intruders, leaving him to finish it alone.

At the start of round 2, the characters see the bodies consumed by aquamarine fire and reduced to bone and ash, from which another [**grell**](statblocks/MM/Grell.md) emerges. Viallis and this second grell then join the fight in round 3.

If the characters reached this area without making an undue amount of noise (and if the guard in area B3 did not come here to warn of the characters' intrusion), three [**cult fanatics**](statblocks/MM/Cult Fanatic.md) lurk behind the statue—the same three who watch the north stairs if Lord Viallis is expecting trouble. They join the fray.

[**Faerl**](statblocks/CM/Faerl.md) is also here if he was able to flee Waterdeep and you did not choose to have the characters meet him at his house. He is reclining on one of the pews. Without his coterie of bodyguards to protect him, he tries to flee the scene (and the temple) as soon as the battle starts.
...
***South Cell.*** This cell holds six prisoners, including Yaeda Firenni, Mayor Kara's sister. Though she originally joined Lord Viallis willingly, Yaeda was imprisoned after the full scope of the cult was revealed to her and she tried to flee. She is in poor health; treat her as an unarmed [**commoner**](statblocks/MM/Commoner.md) with 4 levels of exhaustion.
...
The four remaining prisoners include three unarmed [**commoners**](statblocks/MM/Commoner.md) and a child noncombatant. Their names are Jalrax, Durz, Seffra, and Ashlan. They were part of a caravan attacked by the cultists a few days earlier. Two of their companions (the unfortunate victims in the chapel) were taken from the cell a few hours earlier.

#### B12. Acolytes' Training Room

Scrolls and notes are spread across the floor of this worked stone alcove. Four recent recruits of the Burnt Tongue Cult (three [**cultists**](statblocks/MM/Cultist.md) and one [**cult fanatic**](statblocks/MM/Cult Fanatic.md)) normally work here to learn and practice spellcasting. You can make the encounter tougher by adding two [**gricks**](statblocks/MM/Grick.md) that act as watchdogs. If the cultist from area B3 passed through here to warn Lord Viallis of intruders, the creatures in this area are waiting for the characters and ready to fight. If they have not been warned, the gricks remain alert but the cultists are distracted as they try to cast a spell under the cult fanatic's watchful eye.
