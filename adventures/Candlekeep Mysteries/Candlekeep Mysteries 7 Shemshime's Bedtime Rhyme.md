...
![Shemshime's Bedtime Rhyme](img/adventure/CM/042-06-001.Book.webp)
...
After spending the night here, all the characters wake up in the morning with the same tune in their heads, and each one hums it under their breath. They soon discover that the tune has "spread" to the Firefly Cellar's other occupants, and the Avowed institute a quarantine to contain what is actually a curse. The adventure is built around a sequence of events that unfold when the characters are quarantined in Candlekeep's Firefly Cellar with a handful of the library's attendants, in an attempt to keep [**Shemshime**](statblocks/CM/Shemshime.md)'s curse from spreading throughout the entire library. The events describe [**Shemshime**](statblocks/CM/Shemshime.md)'s growing supernatural influence and how people deal with the mounting pressure of confinement under dangerous circumstances.

The characters must identify the curse's source. Their search eventually leads them to Crinkle, the Firefly Cellar's kenku caretaker, who has the book. *Shemshime's Bedtime Rhyme* contains the malevolent spirit called [**Shemshime**](statblocks/CM/Shemshime.md), and the book holds the secret of how to stop it.
...
Event 4: Escape Attempt. A visiting scholar named [**K'Tulah**](statblocks/CM/K'Tulah.md) succumbs to the mounting tension and tries to break out of the cellar, threatening to spread the curse throughout Candlekeep.

Event 5: Puppets. [**Shemshime**](statblocks/CM/Shemshime.md)'s magic takes control of characters trapped in the library, causing them to violently turn on each other.

Event 6: Shemshime. The characters find the book and must discover how to stop the curse while confronting [**Shemshime**](statblocks/CM/Shemshime.md).
...
>
>Does the shadow have a name? [**SHEMSHIME**](statblocks/CM/Shemshime.md) Causes grief, avoids the blame [**SHEMSHIME**](statblocks/CM/Shemshime.md)
>
...
Centuries ago, a family living in a remote water mill endured a string of unfortunate events. A malevolent spirit called [**Shemshime**](statblocks/CM/Shemshime.md) attached itself to the family and caused the "accidents." The daughter finally destroyed [**Shemshime**](statblocks/CM/Shemshime.md) by crushing it under a millstone that had been blessed by a traveling halfling cleric of Chauntea (god of agriculture).

The story became a local legend, a cautionary tale meant to warn people to keep their attention on their chores. When a traveling gnome bard heard the tale, he was so intrigued that he set the story down in the book, *Shemshime's Bedtime Rhyme*. By doing so, he inadvertently created a conduit through which [**Shemshime**](statblocks/CM/Shemshime.md) could return.
...
Before the adventurers arrive at the Firefly Cellar at the beginning of the adventure, Crinkle brought the book to her room (area F11) and opened it. The music box started to play, and she became the subject of [**Shemshime**](statblocks/CM/Shemshime.md)'s curse.

The rhyme is presented in the accompanying handout. Until the music box is repaired, it always skips back to the beginning of the song before playing the last stanza. That means the last stanza of [**Shemshime**](statblocks/CM/Shemshime.md)'s rhyme doesn't get implanted in the minds of those who hear the song until the music box is fixed and the tune plays in its entirety. The missing stanza is as follows:
...
The rhyme acts as a summoning ritual intended to restore [**Shemshime**](statblocks/CM/Shemshime.md). When enough people join in the singing of the rhyme, or enough time passes while people are singing it, the ritual will be completed. As that occasion approaches, [**Shemshime**](statblocks/CM/Shemshime.md)'s power grows. Anyone who hears the cursed tune is in turn cursed to hum or sing it. They are then capable of transmitting it further.
...
[**Varnyr**](statblocks/CM/Varnyr.md) is a senior scribe who has spent centuries at Candlekeep. She loves the books, which she cares for as though they were her grandchildren. She has little ambition to rise in the ranks of the Avowed, perfectly content as a senior scribe. She is hardworking and expects others to be as well.

[**Varnyr**](statblocks/CM/Varnyr.md) was an adjutant when [**Shemshime**](statblocks/CM/Shemshime.md)'s curse first came to Candlekeep, though she is unaware that the book was the cause of the madness.

[**Varnyr**](statblocks/CM/Varnyr.md) is a [**noble**](statblocks/MM/Noble.md) with the following changes:

- [**Varnyr**](statblocks/CM/Varnyr.md) speaks Common and Elvish, and she has darkvision out to a range of 60 feet. She has advantage on saving throws against being charmed, and magic can't put her to sleep.
- Instead of a rapier, [**Varnyr**](statblocks/CM/Varnyr.md) wields a cane and can use an action to make two melee weapon attacks with it: +3 to hit, reach 5 ft., one target. *Hit*: 2 (1d4) bludgeoning damage.
...
Ebder is a [**commoner**](statblocks/MM/Commoner.md) who speaks Common and has a set of *calligrapher's supplies*.

***Personality Trait.*** "I'm an anxious person. I worry about what Senior Scribe [**Varnyr**](statblocks/CM/Varnyr.md) thinks about me and my work."
...
[**K'Tulah**](statblocks/CM/K'Tulah.md) is a gregarious tabaxi, a catlike humanoid. She arrived at Candlekeep six days ago and received permission to use the library to conduct her research on regional forms of folk magic.

She is an animated talker whose exaggerated gesticulations while chatting annoy [**Varnyr**](statblocks/CM/Varnyr.md), but the elf appreciates her academic expertise.

[**K'Tulah**](statblocks/CM/K'Tulah.md) is a tabaxi [**druid**](statblocks/MM/Druid.md) with the following changes:

- [**K'Tulah**](statblocks/CM/K'Tulah.md) speaks Common and Druidic, and she has darkvision out to a range of 60 feet.
- When [**K'Tulah**](statblocks/CM/K'Tulah.md) moves on her turn in combat, she can double her speed until the end of the turn. Once she uses this ability, she can't use it again until she moves 0 feet on one of her turns.
- As an action, [**K'Tulah**](statblocks/CM/K'Tulah.md) can make a melee weapon attack with her claws: +2 to hit, reach 5 ft., one target. *Hit*: 2 (1d4) slashing damage.
...
Crinkle has little patience for others, and she regards Senior Scribe [**Varnyr**](statblocks/CM/Varnyr.md)'s restoration efforts as an invasion. Gailby Smallstone has softened the kenku's dour disposition with her appreciation of interesting objects.

Crinkle is a [**kenku**](statblocks/MM/Kenku.md) who has a *ring of the ram* that has all its charges.
...
When they arrive, they find the elderly elf [**Varnyr**](statblocks/CM/Varnyr.md) precariously balanced on a ladder while arranging a few of the flowerpots on top of one of the bookcases. She's engrossed in her work. Before the characters say anything, she starts speaking without looking at them.

>>"Ebder, are you back?"
>>
>>"I never left!" grumbles a voice from below.
>>
>>"Oh?" The elf looks down and seems surprised at your presence. Then she says, indicating the room around her, "Ah. Visitors. I'm Scribe [**Varnyr**](statblocks/CM/Varnyr.md). Sorry for the state of things. As you see, the restoration project is a work in progress. I'll be with you shortly." She returns to her work. A moment later, she says, "Actually, would you mind bringing that stack of books downstairs to Ebder? I'll meet you there." She points to a small pile of books on a stool. "Thanks so much."
>>
...
[**K'Tulah**](statblocks/CM/K'Tulah.md) is vocal about her discomfort with being confined down here. Ebder regards the quarantine as a minor annoyance and complains that all the commotion interferes with his work. Crinkle and Gailby are not present.

[**Varnyr**](statblocks/CM/Varnyr.md) refuses to speculate about the "madness," since she's not a spellcaster and doesn't want to guess at the cause without evidence. "But perhaps you can find an answer in all this," she says, waving at the disheveled room.
...
[**Shemshime**](statblocks/CM/Shemshime.md)'s influence has begun to reach into the world. When Ebder stops singing, roll on the [**Shemshime**](statblocks/CM/Shemshime.md)'s Influence table to find out what happens next.

#### Haunting Occurrences

After Ebder's outburst, [**Shemshime**](statblocks/CM/Shemshime.md)'s influence manifests in the Firefly Cellar in several unsettling ways. From this point forward, whenever at least half the characters are singing [**Shemshime**](statblocks/CM/Shemshime.md)'s rhyme, roll on the [**Shemshime**](statblocks/CM/Shemshime.md)'s Influence table to determine what happens. Add more of these rolls as you see fit, even during later events.
...
Share the handout of [**Shemshime**](statblocks/CM/Shemshime.md)'s rhyme with your players. The final stanza is absent from the handout. Going forward, whenever a character is compelled to hum [**Shemshime**](statblocks/CM/Shemshime.md)'s rhyme, they sing the words to the tune instead.

>>You become aware that the song is not only in your head. Somewhere nearby, a deep and melodic voice is singing the words.
>>

The skull continues to sing unless it's destroyed or [**Shemshime**](statblocks/CM/Shemshime.md) is trapped in *Shemshime's Bedtime Rhyme*. The skull is a Tiny object with AC 15, 4 hit points, and immunity to poison damage.

### Event 4: Escape Attempt

[**K'Tulah**](statblocks/CM/K'Tulah.md) reaches the end of her patience with being confined, and she tries to break the quarantine. This event can begin in any area.

When you're ready to begin this event, read the following boxed text aloud:

>>[**K'Tulah**](statblocks/CM/K'Tulah.md), biting her lip to keep from singing, slumps to the floor with her back against a wall and her head in her hands. After a moment her ears flatten, and she springs up and takes off at a full sprint.
>>

[**K'Tulah**](statblocks/CM/K'Tulah.md) runs for the hatch in the ceiling of area F1. She tries to evade anyone who stands in her path but fights them if necessary. If she reaches the hatch, she attempts to force the door. When that doesn't work, she demands that [**Varnyr**](statblocks/CM/Varnyr.md) open it, but [**Varnyr**](statblocks/CM/Varnyr.md) refuses. Unless [**K'Tulah**](statblocks/CM/K'Tulah.md) is subdued, she attacks [**Varnyr**](statblocks/CM/Varnyr.md) to get the key.

A character can try to calm [**K'Tulah**](statblocks/CM/K'Tulah.md), doing so with a successful DC 15 Charisma (Persuasion) check. A *calm emotions* spell or similar magic also does the trick, as does giving [**K'Tulah**](statblocks/CM/K'Tulah.md) the mechanical oyster from her quarters (area F13).
...
Choose half of the remaining characters, including NPCs (other than Gailby and Crinkle). Those who are not under the effect of a *protection from evil and good* spell or similar magic must succeed on a DC 15 Charisma saving throw or be charmed by [**Shemshime**](statblocks/CM/Shemshime.md) for 1 minute. While charmed in this way, the creature is under [**Shemshime**](statblocks/CM/Shemshime.md)'s control and is compelled to sing [**Shemshime**](statblocks/CM/Shemshime.md)'s rhyme repeatedly while trying to cause physical harm to others.

Creatures whose actions and movements are being controlled by [**Shemshime**](statblocks/CM/Shemshime.md) remain aware of what's going on around them, but they are powerless to stop themselves from causing harm in accordance with [**Shemshime**](statblocks/CM/Shemshime.md)'s wishes.

[**Shemshime**](statblocks/CM/Shemshime.md)'s control over a creature is broken by the break enchantment effect of a *dispel evil and good* spell (magic that is probably beyond the characters' ability to cast) or by reducing the creature to 0 hit points. A charmed creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. If a creature succeeds on the saving throw or the effect ends on it, [**Shemshime**](statblocks/CM/Shemshime.md) can't take control of that creature again for 24 hours.

![Scenes in the Opened Book](img/adventure/CM/045-06-004.scenes-in-the-opened-book.webp)

### Event 6: Shemshime

The final event revolves around interacting with the book and learning the last stanza of the rhyme, which tells how to foil [**Shemshime**](statblocks/CM/Shemshime.md) and end the curse. Meanwhile, [**Shemshime**](statblocks/CM/Shemshime.md) coalesces around the book, lashing out at the characters to stop them from thwarting its manifestation.
...
[**Shemshime**](statblocks/CM/Shemshime.md) attacks the characters, focusing its attention on anyone near the book. It also tries to break the characters' concentration, since it gains power when the rhyme is sung.
...
![Shemshime](img/adventure/CM/046-637514193181534197.webp)

#### Destroying the Book

Destroying the book does nothing to defeat or otherwise impede [**Shemshime**](statblocks/CM/Shemshime.md). *Shemshime's Bedtime Rhyme* is a Tiny object with AC 14, 15 hit points, a damage threshold of 15 (see "Damage Threshold" in the *Dungeon Master's Guide*), and immunity to poison and psychic damage.

#### Defeating Shemshime

To defeat [**Shemshime**](statblocks/CM/Shemshime.md), it must be crushed by an object weighing at least 1,000 pounds. Objects in the Firefly Cellar that qualify include the book sculpture suspended from the ceiling in area F1, the bookcases in areas F1 and F2, and the stone table in area F2.

Luring [**Shemshime**](statblocks/CM/Shemshime.md) to where it can be crushed takes some effort. Because [**Shemshime**](statblocks/CM/Shemshime.md) is fixated on the book, the spirit pursues whoever has it. In other words, the characters can use the book itself to lure [**Shemshime**](statblocks/CM/Shemshime.md) into harm's way.

Once [**Shemshime**](statblocks/CM/Shemshime.md) is in position, a character can use an action to drop or topple a heavy object on it. [**Shemshime**](statblocks/CM/Shemshime.md) must succeed on a DC 15 Dexterity saving throw to avoid being crushed under the object. On a failed save, [**Shemshime**](statblocks/CM/Shemshime.md) vanishes and one of the following outcomes occurs:

- If the book is intact, [**Shemshime**](statblocks/CM/Shemshime.md) is yanked back into the book. It slams shut, silencing the music box and ending the curse.
- If the book has been destroyed, [**Shemshime**](statblocks/CM/Shemshime.md) is pulled into the nearest closed book, ending the curse. That book transforms into a copy of *Shemshime's Bedtime Rhyme*, destroying the book's original content in the process.

Once [**Shemshime**](statblocks/CM/Shemshime.md) is trapped again, [**Varnyr**](statblocks/CM/Varnyr.md) or whoever has the key unlocks the hatch in area F1. [**Varnyr**](statblocks/CM/Varnyr.md) or Ebder immediately takes the book to lock it away in one of Candlekeep's secure vaults.

***Reward.*** The Avowed give the characters a *bag of holding* as a reward for defeating [**Shemshime**](statblocks/CM/Shemshime.md).

> ##### Troubleshooting
>
>The adventure assumes that the quarantine remains intact. But there's a reasonable chance the characters in your game will want to leave the confines of the Firefly Cellar or even help [**K'Tulah**](statblocks/CM/K'Tulah.md) escape. It's up to you whether to allow this and to consider how Candlekeep responds.
>
...
The basement library known as the Firefly Cellar is located beneath the House of Rest. It's entirely below ground, containing a collection of old manuscripts that focus primarily on travelogues and regional customs. Until Senior Scribe [**Varnyr**](statblocks/CM/Varnyr.md) initiated a restoration effort, its books had been largely neglected over the past few centuries.
...
The bottom floor contains a kitchen and living quarters. For many years, Crinkle was the only occupant, but [**Varnyr**](statblocks/CM/Varnyr.md), Ebder, and Gailby have moved in during the recent restoration effort.
...
[**Varnyr**](statblocks/CM/Varnyr.md)'s restoration project began in this room, and it's tidier and more welcoming than the chamber below. She has brought in rugs and flowers and polished the statues. Three of the statues were in such a poor state that she replaced them with comfortable reading chairs.
...
***Writing on the Wall.*** Anyone who searches behind the tapestry finds words scratched into the stone wall—the lyrics of [**Shemshime**](statblocks/CM/Shemshime.md)'s rhyme except for the final stanza. They were carved by Yowen Pilt, who was sealed in this room because of his madness.
...
Books in need of repair are brought to the bindery. [**Varnyr**](statblocks/CM/Varnyr.md) loves this task, and it's her work on display on the bench. The tools are used for bookbinding, leatherworking, woodcarving, and painting.
...
Each candlestick is lit by a *continual light* spell that [**Varnyr**](statblocks/CM/Varnyr.md) can suppress by speaking a command word known only to her. The books in here represent [**Varnyr**](statblocks/CM/Varnyr.md)'s personal collection.

The room includes a large cushion (which [**Varnyr**](statblocks/CM/Varnyr.md) sits on whenever she enters a trance to rest), an armoire, and a green velvet reading chair. The armoire contains clothes as well as a pile of books that won't fit on the shelves.
