...
>
>At will: {@spell detect evil and good}, {@spell invisibility} (self only)  
>1/day each: {@spell commune}, {@spell control weather}  
>3/day each: {@spell blade barrier}, {@spell dispel evil and good}, {@spell resurrection}  
>
>### Actions
>
...
>
>### Legendary Actions
>{@note Legendary Action Uses: 3. Immediately after another creature's turn, Solar can expend a use to take one of the following actions. Solar regains all expended uses at the start of each of their turns.}
>
